  ...
  return (
    <div className={styles.root}>
      ...
      <section className={styles.hero}>
        ...
        <Link to="/new" className={styles.heroCta}>Get started →</Link>
      </section>
      ...
      <section className={styles.section}>
        ...
        {loading ? (
          ...
          <div className={styles.empty}>
            ...
            <Link to="/new" className={styles.btnPrimary}>Create a wish</Link>
          </div>
        ) : (
          <div className={styles.grid}>
            {pubs.map(pub => (
              <div key={pub._id} className={styles.card} onClick={() => navigate(`/edit/${pub._id}`)}>
                ...
                <div className={styles.cardActions}>
                  ...
                  <button className={styles.btnIcon} onClick={() => navigate(`/edit/${pub._id}`)}>✏️</button>
