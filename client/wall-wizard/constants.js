...
export const BACKGROUNDS_CATALOG = [
  ...
  {
    id: 'plain-white', label: 'Blanc pur', tab: 'plain', css: '#FFFFFF', ink: '#2B2440', preview: '#FFFFFF',
  },
  {
    id: 'plain-rose', label: 'Rose Kado', tab: 'plain', css: '#FF5470', ink: '#FFFFFF', preview: '#FF5470',
  },
  {
    id: 'plain-ink', label: 'Ink myKado', tab: 'plain', css: '#2B2440', ink: '#FFFFFF', preview: '#2B2440',
  },
];
