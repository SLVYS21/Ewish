...
export const OCCASIONS = [
  {
    id: 'anniversaire', label: 'Anniversaire', icon: 'birthday-cake',
  ...
  {
    id: 'mariage', label: 'Mariage', icon: 'two-hearts',
  ...
  {
    id: 'merci', label: 'Remerciement', icon: 'folded-hands',
    title: 'Merci ❤️',
  ...
  {
    id: 'retablissement', label: 'Bon rétablissement', icon: 'bouquet',
  ...
  {
    id: 'fete_mere', label: 'Fête des mères', icon: 'smiling-face-hearts',
  ...
  {
    id: 'fete_pere', label: 'Fête des pères', icon: 'red-heart',
  ...
  {
    id: 'saint_valentin', label: 'Saint-Valentin', icon: 'sparkling-heart',
    title: "Je t'aime ❤️",
  ...
  {
    id: 'noel', label: 'Noël', icon: 'wrapped-gift',
    title: 'Joyeux Noël 🎄',
  ...
  {
    id: 'bapteme', label: 'Baptême', icon: 'dove',
    title: 'Bénédictions 🕊️',
  ...
  {
    id: 'communion', label: 'Communion', icon: 'folded-hands',
    title: 'Bénédictions 🕊️',
  ...
  {
    id: 'retraite', label: 'Départ à la retraite', icon: 'clinking-glasses',
  ...
  {
    id: 'condoleances', label: 'Condoléances', icon: 'dove',
